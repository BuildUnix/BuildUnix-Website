...
export const siteMetadata = {
  name: "BuildUNIX",
  shortName: "BuildUNIX",
  tagline: "Digitising Construction Execution",
  homeTitle: "BuildUNIX",
  homeDescription:
    "Digitising Construction \u2014 BuildUNIX is a construction execution platform for PMC firms in India. Phase-gated workflows, tamper-proof photo verification, and accountability.",
  homeOgTitle: "BuildUNIX",
  homeOgDescription:
    "Digitising Construction \u2014 Phase-gated workflows, tamper-proof photo verification, and real-time site accountability for PMC-led construction.",
  aboutTitle: "Why Use BuildUNIX \u2014 Built for Indian PMC Firms",
  aboutDescription:
    "Why PMC-led projects choose BuildUNIX: hard-gated phase sequencing, tamper-proof photo evidence, formal snag tracking, live heatmaps, and automated daily reporting.",
  contactTitle: "Contact \u2014 BuildUNIX",
  contactDescription:
...
export const navLinks = [
  ...
  { label: "Portal", href: "https://portal.buildunix.com" }
];
...
export const testimonials = [
  ...
  {
    quote: "I get the automated report at 9 PM every day. My team stopped sending me WhatsApp updates — everything I need is already in the PDF.",
    name: "Krishnamurthy",
...
export const faqs = [
  ...
  },
  {
    ...
    a: "Yes — we run a free 30-day pilot on your first project. A BuildUNIX engineer configures everything and stays available throughout the pilot."
  },
  {
...
export const heroContent = {
  ...
  subheadline:
    "A phase-enforced construction operating system built for Indian PMC firms. Mandatory photo documentation. Real-time progress heatmaps. Automated daily reports. PMC approval is the only unlock trigger.",
...
export const problemStats = [
  ...
  },
  {
    value: "9:00 PM",
    accent: true,
    label: "when BuildUNIX delivers your daily site report \u2014 fully automated."
  }
];
...
export const howItWorksSteps = [
  ...
  },
  {
    id: "report",
    label: "Step 5",
    title: "The system writes your daily report.",
    body:
      "A full narrative PDF \u2014 timeline, gallery, snag summary, and completion stats \u2014 is generated automatically and delivered at 9 PM. Zero manual input.",
    visual: "report"
  }
];
...
export const trustColumns = [
  ...
  {
    title: "The Smart Intelligence Layer",
    body:
      "At 9 PM every evening, a full system-generated narrative site report is delivered automatically to Project Managers and configured stakeholders. Chronological activity log. Photo gallery. Snag summary. Zero manual effort."
  }
];
...
export const whyBuildUNIXMoat = [
  ...
  },
  {
    ...
    body:
      "The audit trail grows automatically: approvals, photos, snags, comments, and daily reports accumulate into a defensible project record that gets more valuable over time."
  }
];
